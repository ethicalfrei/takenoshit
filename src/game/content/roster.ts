...
export type BossId = "roommate" | "leaf" | "baker" | "barista" | "manager" | "hr" | "gym" | "boss" | "cops";
...
export const ROSTER: BossDef[] = [
  ...
  {
    id: "hr",
    name: "Patricia Handbook",
    subtitle: "The HR Manager",
    clock: "9:41 AM",
    place: "The HR suite",
    introLine: "I saw the incident report. Let's discuss your tone.",
    tauntLines: [
      "This is a safe space. For me.",
      "I'm documenting everything.",
      "Have you considered conflict resolution?",
      "That's not how we handle feedback here.",
      "I'll need you to acknowledge receipt.",
      "Open door policy. Closed fist.",
    ],
    hurtLines: ["That's retaliation—", "I have forms!", "This goes in your file."],
    koLine: "Fine. No formal write-up. This time.",
    hp: 130,
    stunThreshold: 54,
    guardCycleMs: 1220,
    music: "midday",
    ...
    patterns: [
      ...
      { id: "binder-high", telegraphMs: 490, activeMs: 300, recoverMs: 420, lane: "high", kind: "projectile", damage: 14, projectile: "stapler", telegraphCue: "handbook overhead, duck" },
      { id: "pen-l", telegraphMs: 500, activeMs: 240, recoverMs: 400, lane: "left", kind: "melee", damage: 14, telegraphCue: "red pen slash left" },
      { id: "pen-r", telegraphMs: 500, activeMs: 240, recoverMs: 400, lane: "right", kind: "melee", damage: 14, telegraphCue: "red pen slash right" },
      { id: "policy", telegraphMs: 470, activeMs: 310, recoverMs: 390, lane: "center", kind: "slam", damage: 16, telegraphCue: "mandatory policy shockwave" },
